library(igraph); 
subnet <- read.table('/nfs/team205/jb62/other/Stip1-in-early-development/results/single_cell//Late blastocyst.16-cell/Cells_FlowNetwork_all_paths_subnet.txt', sep='	', header = TRUE);
totalFlow <- read.table('/nfs/team205/jb62/other/Stip1-in-early-development/results/single_cell//Late blastocyst.16-cell/Cells_FlowNetwork_all_paths_totalFlow.txt', sep='	', header = TRUE);
...
write.graph(iG2,'/nfs/team205/jb62/other/Stip1-in-early-development/results/single_cell//Late blastocyst.16-cell/Cells_FlowNetwork_all_paths_subnet.gml', format = 'gml');
#--------------------------------------------------------------------------
